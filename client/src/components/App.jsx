...
import Map from './Map';
import DiagnosticContainer from './homePage/DiagnosticContainer';
import { appConfig } from '../utils/constants';
import FactQuizContainer from './Cards/FactQuizContainer';
import Survey from './survey/Survey';
import OnboardUser from './more/user/OnboardUser';
import About from './more/About';
import Disclaimer from './homePage/Disclaimer';
import NotFoundPage from '../pages/NotFoundPage';
import actions from '../redux/actions/actions';
import ScrollToTop from './ScrollToTop';
import Settings from './more/user/Settings';
